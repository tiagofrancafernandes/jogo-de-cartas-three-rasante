...
export const translations: Record<SupportedLocale, Translations> = {
    'pt-BR': {
        ...
        statusDraw: 'Empate',
        close: 'Fechar',
        rulesModalTitle: 'Manual de Regras - Rasante',
    ...
    'en-US': {
        ...
        statusDraw: 'Draw',
        close: 'Close',
        rulesModalTitle: 'Official Rules Manual - Rasante',
